...
CREATE TABLE IF NOT EXISTS CasualCook (
    ...
    NewsOptIn tinyint(1),
    FOREIGN KEY (CookID) REFERENCES User (UserID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Chef (
    ...
    Country varchar (50),
    FOREIGN KEY (ChefID) REFERENCES User(UserID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Follows (
    ...
    DateFollowed date,
    FOREIGN KEY (FollowerID) REFERENCES CasualCook (CookID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (FolloweeID) REFERENCES Chef (ChefID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Review (
    ...
    ReviewDate date,
    FOREIGN KEY (CookID) REFERENCES CasualCook (CookID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Endorses (
    ...
    FOREIGN KEY (EndorsingChefID) REFERENCES Chef (chefID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Analyst (
    ...
    HireDate date,
    FOREIGN KEY (AnalysisID) REFERENCES User (UserID) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS SearchDiet (
    ...
    FOREIGN KEY (SearchID) REFERENCES Search (SearchID) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (DietRestID) REFERENCES DietaryRestrictions (DietRestID) ON DELETE CASCADE ON UPDATE CASCADE
)
